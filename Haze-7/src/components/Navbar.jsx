                ...
                <div className="flex">
                  <div className="nav-entry-outside">
                    <div className="nav-entry-setup">
                      ...
                      {/* Linkedin Logo*/}
                      <div className="navbar-entry">
                        <Link to="https://www.linkedin.com/in/hayes-chiasson-413955249/" className="bg-gold w-8 h-8">
                      ...
                      {/* Github Logo */}
                      <div className="navbar-entry">
                        <Link to="https://github.com/Haze-7" className="w-[2rem] h-[2rem] bg-gold rounded-full">
