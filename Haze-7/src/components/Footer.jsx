          ...
          <div className="footer-content-container">
            ...
            <div className="sm:min-h-[20vh] w-full"> 
              ...
              <div className="flex flex-col md:flex-row flex-wrap mt-auto">
                ...
                <a href="https://github.com/Haze-7" className="footer-contact-entry">
                  <div className="footer-contact-icon pt-[0.3rem]">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                ...
                {/*Instagram Contact Entry*/}
                <a href="https://www.instagram.com/hayes_chiasson/" className="footer-contact-entry">
                  <div className="footer-contact-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                ...
                {/*Discord Contact Entry*/}
                <a href="https://discord.com/" className="footer-contact-entry">
                  <div className="footer-contact-icon pt-[0.3rem]">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
